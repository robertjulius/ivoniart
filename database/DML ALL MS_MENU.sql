...
INSERT INTO ms_menu_home (id, create_by, create_date, rec_status, update_by, update_date, quick_link1, quick_link2) VALUES ('1', 'SYSTEM', CURRENT_TIMESTAMP, 'A', 'SYSTEM', CURRENT_TIMESTAMP, 'This is the quick link 1', 'This is the quick link 2');

DELETE FROM ms_web_items;
INSERT INTO ms_web_items (id, create_by, create_date, rec_status, update_by, update_date, logo_img, copyright, bg_img) VALUES ('1', 'SYSTEM', CURRENT_TIMESTAMP, 'A', 'SYSTEM', CURRENT_TIMESTAMP, '1366444495481', 'Copyright by Robert Julius', '1366444495481');
