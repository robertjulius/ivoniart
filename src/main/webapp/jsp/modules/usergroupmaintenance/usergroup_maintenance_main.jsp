				...
				<table class="form">
					<tr>
						<td>
							<ul>
								<li>
									<a href="<%=request.getContextPath()%>/modules/usergroupmaintenance/prepareCreate.action"><b><s:text name="resource.create.new" /></b></a>
								</li>
							</ul>
						</td>
					</tr>
					...
					<tr>
						<td>
							<s:form action="/modules/usergroupmaintenance/search.action" method="post">
								<s:actionerror />
								<s:fielderror />
