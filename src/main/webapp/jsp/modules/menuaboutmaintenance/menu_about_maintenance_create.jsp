...
<body>
	...
	<s:form action="/modules/menuaboutmaintenance/validateCreate.action" theme="simple">
					...
					<table>
						<tr>
							<td><input type="button" value="<s:text name="resource.cancel"/>"
								onclick="if (!confirmCancel()) {return;} $(this).closest('form').attr('action', '<%=request.getContextPath()%>/modules/menuaboutmaintenance/main.action'); $(this).closest('form').submit();" /></td>
