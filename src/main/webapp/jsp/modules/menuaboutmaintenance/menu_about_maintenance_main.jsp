...
<body>
	<table>
				...
				<table class="form">
					<tr>
						<td>
							<ul>
								<li>
									<a href="<%=request.getContextPath()%>/modules/menuaboutmaintenance/prepareCreate.action"><b><s:text name="resource.create.new" /></b></a>
								</li>
							</ul>
						</td>
					</tr>
					...
					<tr>
						<td>
							<s:form action="/modules/menuaboutmaintenance/search.action" method="post">
								<s:actionerror />
								<s:fielderror />
		...
		<s:if test="searchResult != null">
			<tr>
				<td>
					<s:form action="/modules/menuaboutmaintenance/prepareDetail.action" theme="simple">
			...
			<tr>
				<td><g:pagination formAction="/modules/menuaboutmaintenance/search.action" /></td>
			</tr>
		</s:if>
	</table>
</body>
