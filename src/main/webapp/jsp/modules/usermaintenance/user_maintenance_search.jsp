...
<body>
	<table>
		<tr>
			<td>
				<h1>
					<s:text name="resource.page.title.userMaintenance" />
				</h1>
			</td>
		</tr>
	</table>
	<s:form action="/modules/usermaintenance/prepareDetail.action"
		theme="simple">
					...
					<table class="grid">
						<thead>
							<tr align="center">
								...
								<td><s:text name="resource.userGroup" /></td>
							</tr>
						</thead>
					...
					<table>
						<tr>
							<td><input type="button"
								...
								onclick="$(this).closest('form').attr('action', '<%=request.getContextPath()%>/modules/usermaintenance/main.action'); $(this).closest('form').submit();" /></td>
						</tr>
					</table>
				</td>
			</tr>
