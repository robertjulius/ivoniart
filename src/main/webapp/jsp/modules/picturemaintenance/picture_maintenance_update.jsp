...
<body>
	...
	<s:form action="/modules/picturemaintenance/validateUpdate.action" theme="simple">
		<table>
			<tr>
					...
					<table>
						<tr>
							<td><input type="button" value="<s:text name="resource.cancel"/>"
								onclick="if (!confirmCancel()) {return;} $(this).closest('form').attr('action', '<%=request.getContextPath()%>/modules/picturemaintenance/detail.action'); $(this).closest('form').submit();" /></td>
