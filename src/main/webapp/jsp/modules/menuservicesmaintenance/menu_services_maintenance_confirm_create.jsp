...
<body>
	...
	<s:form action="/modules/menuservicesmaintenance/executeCreate.action" theme="simple">
					...
					<table class="grid" id="grid2">
						...
						<tbody>
							<tr>
								...
								<td align="left" width="300px"><s:property value="newPicture" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align="left" width="300px"><s:property value="newContent" /></td>
							</tr>
							<tr>
								<td align="right" width="100px"><s:text name="resource.services" /></td>
								<td align="left" width="300px"><s:property value="newServices" /></td>
							</tr>
						</tbody>
					</table>
				</td>
					...
					<table>
						<tr>
							<td><input type="button" value="<s:text name="resource.back"/>"
								onclick="$(this).closest('form').attr('action', '<%=request.getContextPath()%>/modules/menuservicesmaintenance/formCreate.action'); $(this).closest('form').submit();" /></td>
