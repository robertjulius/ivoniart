...
<body>
	...
	<s:form action="/modules/menuservicesmaintenance/validateUpdate.action" theme="simple">
			...
			<tr>
				<td>
					<table>
						...
						<s:textfield key="resource.services" name="newServices" theme="xhtml" size="30px" />
					</table>
				</td>
			</tr>
			<tr>
