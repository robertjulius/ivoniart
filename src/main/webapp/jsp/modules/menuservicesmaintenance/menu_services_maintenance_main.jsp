...
<body>
	<table>
				...
				<table class="form">
					<tr>
						<td>
							<ul>
								<li>
									<a href="<%=request.getContextPath()%>/modules/menuservicesmaintenance/prepareCreate.action"><b><s:text name="resource.create.new" /></b></a>
								</li>
							</ul>
						</td>
					</tr>
					...
					<tr>
						<td>
							<s:form action="/modules/menuservicesmaintenance/search.action" method="post">
								<s:actionerror />
								<s:fielderror />
		...
		<s:if test="searchResult != null">
			<tr>
				<td>
					<s:form action="/modules/menuservicesmaintenance/prepareDetail.action" theme="simple">
						...
						<table class="grid">
							<thead>
								<tr align="center">
									...
									<td width="150"><s:text name="resource.content" /></td>
								</tr>
							</thead>
			...
			<tr>
				<td><g:pagination formAction="/modules/menuservicesmaintenance/search.action" /></td>
			</tr>
		</s:if>
	</table>
</body>
