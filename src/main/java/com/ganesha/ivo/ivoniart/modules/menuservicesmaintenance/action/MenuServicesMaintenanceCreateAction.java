...
public class MenuServicesMaintenanceCreateAction extends
		MenuServicesMaintenanceAction {

	private static final long serialVersionUID = 1L;

	public MenuServicesMaintenanceCreateAction() throws AppException {
		super();
	}
	...
	public String executeCreate() throws AppException {
		...
		getBL().create(newPictureId, newTitle, newContent, newServices,
